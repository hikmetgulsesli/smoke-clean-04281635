...
export function GecmisModali(props: GecmisModaliProps) {
  ...
  return (
    <>
      ...
      {/* BottomNavBar */}
      <nav className="bg-[#171f33]/60 backdrop-blur-3xl fixed bottom-0 left-0 w-full rounded-t-[24px] border-t border-[#adc6ff]/15 shadow-[0_-8px_40px_rgba(173,198,255,0.08)] z-10 flex justify-around items-center px-4 pb-8 pt-4 md:hidden">
