...
export function BosGecmisDurumu(props: BosGecmisDurumuProps) {
  ...
  return (
    <>
      ...
      {/* Inactive Tab: Sayaç */}
      <button aria-label="Sayaç" className={clsx(
        "flex flex-col items-center justify-center text-[#adc6ff]/40 px-6 py-2 hover:text-[#adc6ff] transition-all group cursor-pointer",
        highlight && "animate-pulse-ring"
      )} onClick={onNavigateCounter} type="button">
