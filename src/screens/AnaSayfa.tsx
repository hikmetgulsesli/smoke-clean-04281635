...
export function AnaSayfa(props: AnaSayfaProps) {
  return (
    <>
      ...
      <button className="text-[#adc6ff] hover:bg-[#171f33] transition-colors p-2 rounded-full flex items-center justify-center">
      ...
      {/* Decrease (-) */}
      <button className="bg-surface-container-highest text-on-surface w-16 h-16 rounded flex items-center justify-center hover:bg-surface-bright transition-colors active:scale-95">
      <span className="material-symbols-outlined text-3xl">remove</span>
      </button>
      {/* Primary Action (+) */}
      <button className="bg-gradient-to-tr from-primary to-primary-container text-on-primary w-24 h-24 rounded flex items-center justify-center shadow-[0_4px_20px_rgba(173,198,255,0.15)] glow-effect transition-all active:scale-95 duration-200">
      <span className="material-symbols-outlined text-5xl" style={{fontVariationSettings: "'FILL' 1"}}>add</span>
      </button>
      {/* Reset (Sıfırla) */}
      <button className="bg-surface-container-highest text-on-surface px-8 h-16 rounded flex items-center justify-center hover:bg-surface-bright transition-colors active:scale-95 font-body font-medium tracking-wide">
                      Sıfırla
                  </button>
      </div>
      </main>
      ...
      {/* Active Nav Item */}
      <a className="flex flex-col items-center justify-center text-[#adc6ff] bg-[#adc6ff]/10 rounded-xl px-6 py-2 active:scale-95 duration-200 hover:text-[#adc6ff] transition-all group" href="#">
      ...
      {/* Inactive Nav Item */}
      <a className="flex flex-col items-center justify-center text-[#adc6ff]/40 px-6 py-2 hover:text-[#adc6ff] transition-all group" href="#">
